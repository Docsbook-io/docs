...
The editor and the panel chat run the Docsbook agent, so they draw on your project's AI balance ([Plans and pricing](../plans-and-pricing.md)). Editing a file on GitHub costs nothing.
