...
- **Some extras stay on the docsbook.io address for now** — the sitemap, `llms.txt`, moved-page redirects and most structured data; see [Search engines see you](../seo/README.md).
