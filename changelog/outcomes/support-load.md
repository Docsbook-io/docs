---
title: "Support load changelog"
description: "Everything Docsbook shipped that cuts support load — the assistant, the questions it could not answer, dead ends and the feedback readers leave when a page fails them."
---

# Support load changelog
