---
title: "Upkeep time changelog"
description: "Everything Docsbook shipped that cuts the time it takes to keep the docs true — writing, restructuring, staleness detection and the agents that do it for you."
---

# Upkeep time changelog
