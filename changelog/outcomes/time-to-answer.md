---
title: "What Docsbook shipped that shortens time to an answer"
description: "Every release that gets a reader to the answer sooner: search, navigation, the assistant, and the page shapes that put the answer in the first screen."
---

# What Docsbook shipped that shortens time to an answer
