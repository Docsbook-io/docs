...
### POST /api/v1/tools/get_reverse_funnel
...
```bash
curl -X POST 'https://docsbook.io/api/v1/tools/get_reverse_funnel' \
  -H 'Authorization: Bearer dbk_YOUR_API_KEY' \
  -H 'Content-Type: application/json' \
  -d '{"args":{}}'
```
