...
### POST /api/v1/tools/get_chat_outbound_hosts
...
```bash
curl -X POST 'https://docsbook.io/api/v1/tools/get_chat_outbound_hosts' \
  -H 'Authorization: Bearer dbk_YOUR_API_KEY' \
  -H 'Content-Type: application/json' \
  -d '{"args":{}}'
```
