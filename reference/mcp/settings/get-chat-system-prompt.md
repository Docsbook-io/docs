...
curl -X POST 'https://docsbook.io/api/mcp/server' \
  ...
  -d '{"jsonrpc":"2.0","id":1,"method":"tools/call","params":{"name":"get_chat_system_prompt","arguments":{"workspace_id":"<workspace_id>"}}}'
```
...
### POST /api/v1/tools/get_chat_system_prompt
...
```bash
curl -X POST 'https://docsbook.io/api/v1/tools/get_chat_system_prompt' \
  -H 'Authorization: Bearer dbk_YOUR_API_KEY' \
  -H 'Content-Type: application/json' \
