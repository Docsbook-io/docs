...
### POST /api/v1/tools/update_languages
...
```bash
curl -X POST 'https://docsbook.io/api/v1/tools/update_languages' \
  -H 'Authorization: Bearer dbk_YOUR_API_KEY' \
  -H 'Content-Type: application/json' \
