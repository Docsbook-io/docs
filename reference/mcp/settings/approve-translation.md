...
### POST /api/v1/tools/approve_translation
...
```bash
curl -X POST 'https://docsbook.io/api/v1/tools/approve_translation' \
  -H 'Authorization: Bearer dbk_YOUR_API_KEY' \
  -H 'Content-Type: application/json' \
