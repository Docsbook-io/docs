...
### POST /api/v1/tools/list_pending_translations
...
```bash
curl -X POST 'https://docsbook.io/api/v1/tools/list_pending_translations' \
  -H 'Authorization: Bearer dbk_YOUR_API_KEY' \
  -H 'Content-Type: application/json' \
