...
```bash
curl -X POST 'https://docsbook.io/api/v1/tools/list_opportunities' \
  -H 'Authorization: Bearer dbk_YOUR_API_KEY' \
  -H 'Content-Type: application/json' \
  -d '{"args":{"status":"all"}}'
```
