...
### POST /api/v1/tools/set_doc_status
...
```bash
curl -X POST 'https://docsbook.io/api/v1/tools/set_doc_status' \
  -H 'Authorization: Bearer dbk_YOUR_API_KEY' \
  -H 'Content-Type: application/json' \
  -d '{"args":{"path":"<path>","status":"generated"}}'
```
