---
title: "Get negative feedback"
description: "Pages with thumbs-down feedback or AI dislikes, ranked by count (PRO)."
---
...
curl -X POST 'https://docsbook.io/api/mcp/server' \
  ...
  -d '{"jsonrpc":"2.0","id":1,"method":"tools/call","params":{"name":"get_negative_feedback","arguments":{}}}'
```
...
### POST /api/v1/tools/get_negative_feedback
...
```bash
curl -X POST 'https://docsbook.io/api/v1/tools/get_negative_feedback' \
  -H 'Authorization: Bearer dbk_YOUR_API_KEY' \
  -H 'Content-Type: application/json' \
  -d '{"args":{}}'
```
