...
Top search queries from the docs search bar with counts (PRO) — the words readers use. For all three search tables (popular, no results, no click) in one call use collect_onsite_search.
