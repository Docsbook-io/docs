...
tldr: "Docsbook publishes a documentation site straight from a GitHub repository: fork the example repo, connect it at docsbook.io/connect, edit a page on GitHub, and the published site updates on its own."
---
