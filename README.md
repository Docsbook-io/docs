...
- [MCP tools reference](./reference/mcp/README.md) — Every tool and its price class {list}
...
- [REST API](./reference/api/README.md) — Call your docs chat from your backend {code}
