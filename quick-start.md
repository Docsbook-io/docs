...
description: "Generate a documentation site from a website, an idea, or a GitHub repository — no account needed until you're ready to publish."
---
...
Once you're happy with the draft, click the blue button in the draft's toolbar — **Claim website** if you haven't changed anything yet, **Save changes** if you have. Both do the same thing: turn the draft into a site of your own.
...
- Set up your custom domain (Business)
- Enable translation to other languages (PRO)
- Hide the "Powered by Docsbook" badge (Business)
...
[Start free](https://docsbook.io/connect) · [Compare plans](./guides/advanced/premium.md)
