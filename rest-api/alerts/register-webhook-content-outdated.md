---
title: "Register webhook content outdated"
description: "Register a webhook for the 'content_outdated' event (BUSINESS) — the direct call for 'notify us when…', 'alert me if…', 'ping our channel when…' about this event."
---
...
```bash
curl -X POST 'https://docsbook.io/api/v1/register_webhook_content_outdated' \
