...
- [Events](./tracking/events.md) — the full list of events Docsbook records
- [AI usage & costs](./tracking/ai-usage.md) — what your chat was asked, what it answered, and what it cost
- [Read time](./reports/read-time.md) — how time-on-page is measured and what it means
- [Countries](./reports/countries.md) — where readers are, and which of them read a translation
...
- [Webhooks](../webhooks.md) — get told about a traffic drop or an unanswered question instead of checking for one
