...
- Agent jobs now switch on from the card itself, and their settings are one short dialog: what you want done — with what to measure and what a good result looks like already drafted for you — an optional line of your own, and what sets it off: a schedule, something that happens here, or an occasion in an app you have connected, like a merged pull request or a solved ticket. `Agents`
