---
title: "Content and setup: connect GitHub and tune the page"
description: "How Docsbook pulls documentation from a GitHub repository, and which page-level features you can switch on around the content it publishes."
---
...
- [Add an Edit on GitHub link](./setup/github-integration.md) — let readers open a page's source and fix it.
- [Content options](./setup/content-options.md) — breadcrumbs, prev/next, scroll-to-top, Ask AI and the Copy page dropdown.
- [How Docsbook charges for AI usage](./setup/pricing-spec.md) — the project balance, what spends it, and how to cap one source. For the short version, see [Docsbook pricing](../pricing.md).
