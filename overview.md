...
- **MCP server** — 309 tools over the Model Context Protocol, so Claude Code, Cursor or ChatGPT can read your pages, search them, and commit changes back. See [MCP server](./agent-ready/mcp.md).
